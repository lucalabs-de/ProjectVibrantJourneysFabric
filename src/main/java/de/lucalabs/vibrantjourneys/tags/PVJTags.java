...
public class PVJTags {
    ...
    private static TagKey<Block> createBlockTag(final String location) {
        return TagKey.of(RegistryKeys.BLOCK, new Identifier(ProjectVibrantJourneys.MOD_ID, location));
    }

    private static TagKey<Block> createBlockTag(final String namespace, final String location) {
        return TagKey.of(RegistryKeys.BLOCK, new Identifier(namespace, location));
    }

    private static TagKey<Item> createItemTag(final String location) {
        return TagKey.of(RegistryKeys.ITEM, new Identifier(ProjectVibrantJourneys.MOD_ID, location));
    }
}