...
public class PVJPlacements {
  ...
  private static RegistryKey<PlacedFeature> createKey(String name) {
    return RegistryKey.create(Registries.PLACED_FEATURE, new Identifier(ProjectVibrantJourneys.MOD_ID, name));
  }

  public static void register(BootstapContext<PlacedFeature> context, RegistryKey<PlacedFeature> key, RegistryEntry<ConfiguredFeature<?, ?>> feature, List<PlacementModifier> modifiers) {
    context.register(key, new PlacedFeature(feature, modifiers));
  }

  public static void register(BootstapContext<PlacedFeature> context, RegistryKey<PlacedFeature> key, RegistryEntry<ConfiguredFeature<?, ?>> feature, List<PlacementModifier> modifiers, PlacementModifier... extraModifiers) {
  ...
  public static void register(BootstapContext<PlacedFeature> context, RegistryKey<PlacedFeature> key, RegistryEntry<ConfiguredFeature<?, ?>> feature, PlacementModifier... modifiers) {
